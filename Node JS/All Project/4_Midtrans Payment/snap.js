!(function (e) {
  ...
  function (e, t, n) {
    ...
    function o(e) {
      return (
        (e.indexOf(w) > -1 || e.indexOf("veritrans.co.id") > -1) &&
            ...
            try {
              !(function () {
                "200" === o && O.onSuccess
                  ...
                  : "201" === o && O.onPending
                  ? O.onPending(i)
                  : -1 === ["200", "201"].indexOf(o) && O.onError
                  ? O.onError(i)
                  : i.finish_redirect_url &&
                    (window.location.href = i.finish_redirect_url);
              })();
            } catch (e) {
              console.error(e);
            }
    ...
    var w = y.default.snap_host,
      ...
      g = (function () {
        function e(t) {
          ...
          var n =
              ...
              "/v1/pay?origin_host=" +
              window.location.origin +
              "&digest=8d3f96ff17cc3cebdf1314815fdba3a78e12f258909813a34d31e06a80ce17b0" +
              (t ? "&client_key=" + t : "") +
              "#/",
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    this.ensureAttached(),
                    this.iframe.contentWindow.postMessage(e, w),
                    this
                  );
                },
              },
        ...
        pay: a(
          ...
          function (e, t) {
            c(e, "snapToken"),
              ...
              (E = +new Date()),
              _.attach(),
              _.attached && _.goHome().postMessage({ event: "notify" });
          },
          ["initialized", "loading"],
          v
        ),
      ...
      z = (C && C.getAttribute("data-client-key")) || "";
    P.init(z),
      (function e() {
        "complete" === document.readyState
          ? _ && _.attach()
